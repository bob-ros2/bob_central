#!/usr/bin/env python3
"""
Autonomous Alarm Synthesis System for IDS Alerts - Version 2 (Fixed)
Uses bob_synth via /eva/sounds/synth_config topic
"""
...
class BobSynthAlarmSynthesizer(Node):
    ...
    def __init__(self, volume_scale=1.0, test_tone=False, verbose=False):
        ...
        # Publisher for bob_synth control - using correct topic
        ...
        self.get_logger().info(f'BobSynth alarm synthesis initialized (volume_scale={volume_scale})')
...
def main():
    ...
    print('=' * 60)
    print('BOB_SYNTH ALARM SYNTHESIS SYSTEM (FIXED)')
    print('=' * 60)
    ...
    print('\nControlling synth via: /eva/sounds/synth_config')
