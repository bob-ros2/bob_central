...
- **Dashboard Integrity**: The primary dashboard configuration is strictly `/ros2_ws/src/bob_central/config/layout_main.json`. Never attempt to use or create alternative layout files for system resets.
